<!DOCTYPE html>
<?php session_start();
require_once './Model/Category.php';require_once './Model/Flower.php';?>
<html>
    <head>
        <title>Home</title>
        <meta charset="utf-8" />
                ...
                <div class="container">
                    <div class="row">
                        <div class="product-category-grid-style-1">
                            <div class="row">
                                <?php
                                $listCategory = unserialize($_SESSION['listCategory']);
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="row js-product-masonry-layout-1 product-masonry-layout-1">
                            ...
                            <?php
                            $favouriteFlower = unserialize($_SESSION['favouriteFlower']);
                            $fig[0] = "position: absolute; left: 0%; top: 0px;";
                            $fig[1] = "position: absolute; left: 25%; top: 0px;";
                            $fig[2] = "position: absolute; left: 75%; top: 0px;";
                            $fig[3] = "position: absolute; left: 0%; top: 300px;";
                            $fig[4] = "position: absolute; left: 75%; top: 300px;";
                            $i = 0;
                            $item2 = "";
                            foreach ($favouriteFlower as $flow) {
                                if($i == 1) { $item2 = "item-size-2"; } else { $item2 = ""; }
                                echo '
                            <figure class="item '.$item2.'" style="'.$fig[$i].'">
                                <div class="product product-style-2">
                                    <div class="img-wrapper">
                                        ...
                                        <figcaption class="desc">
                                            <h3>
                                                <a class="product-name" href="product-detail.html">'.$flow->getName().'</a>
                                            </h3>
                                            <span class="price">'.$flow->getPrice().'</span>
                                        </figcaption>
                                    </div>
                                </div>
                            </figure>';
